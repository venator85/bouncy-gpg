...
public class Configs {
  ...
  public static EncryptionConfig buildConfigForEncryptionFromResources(String signatureSecretKeyId,
      String signatureSecretKeyPassword) {

    final KeyringConfig keyringConfig = keyringConfigFromResourceForSender(
        KeyringConfigCallbacks.withPassword(signatureSecretKeyPassword));
  ...
  public static KeyringConfig keyringConfigFromFilesForRecipient() {
    return keyringConfigFromFilesForRecipient(
  ...
  public static KeyringConfig keyringConfigFromResourceForRecipient(
    ...
    return KeyringConfigs
        .withKeyRingsFromResources(EncryptWithOpenPGPTestDriverTest.class.getClassLoader(),
  ...
  public static KeyringConfig keyringConfigFromResourceForRecipient() {
    return keyringConfigFromResourceForRecipient(
        KeyringConfigCallbacks.withPasswordsFromMap(ExampleMessages.ALL_KEYRINGS_PASSWORDS));
  }
  ...
  public static KeyringConfig keyringConfigFromFilesForSender() {
    return keyringConfigFromFilesForSender(
        KeyringConfigCallbacks.withPasswordsFromMap(ExampleMessages.ALL_KEYRINGS_PASSWORDS));
  }
  ...
  public static KeyringConfig keyringConfigFromResourceForSender() {
    return keyringConfigFromResourceForSender(
        KeyringConfigCallbacks.withPasswordsFromMap(ExampleMessages.ALL_KEYRINGS_PASSWORDS));
  }
