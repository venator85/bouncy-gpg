 ...
 * It started life as {@link BuildDecryptionInputStreamAPI} and then I started removing decryption
 * stuff. I haven't gone through this that carefully, but have done some quick tests and it does
 * seem to verify GPG-compatible digital signatures.
 * <p>
...
public final class BuildVerificationInputStreamAPI {
    ...
    public interface Build {
        ...
        /**
         * <p> Build the final signed input stream. </p><p> This method will start reading the cipherstream until it
         * finds the encrypted plaintext. </p><p> If the source data is NOT signed, but a signature is REQUIRED, then
         * this function might throw. </p>
         *
         * @param signedData An encrypted input stream. <b>Will not be closed</b>.
         ...
         */
        @Nonnull
        InputStream fromSignedInputStream(final InputStream signedData)
    ...
    public interface Validation {
        ...
        /**
         * <p>Decryption will enforce that the ciphertext has been signed by ALL of the public key ids passed. </p> <p>
         * Given  the following keyring: </p>
         * <pre>{@code
         ...
         * </pre>
         * <p> To require a valid signature from {@code signer@example.com} with the following keyring, call <p>
         * andRequireSignatureFromAllKeys(0x54A3DB374F787AB7L) </p>
         *
         * @param publicKeyIds A valid signature from ALL of the passed keys is required. Each key MUST exist in the
         *                     public keyring.
         ...
         *
         * @param userIds a valid signature from all of the passed uids is required. The keys MUST exist in the public
         *                keyring.
         * @return the next build step
        ...
        /**
         * Enforce a valid signature from *any* public key in the keyring. . Signatures of keys NOT present in the
         * keyring are IGNORED (treated as not existing).
         *
         * @return next build step
         */
        @Nonnull
    ...
    public final class ValidationWithKeySelectionStrategy extends ValidationImpl {
        ...
        ValidationWithKeySelectionStrategy() {
            super();
            BuildVerificationInputStreamAPI.this.keySelectionStrategyBuilder = this;
        }

        /**
         * <p>In order to determine key validity a reference point in time for "now" is needed. The default value is
         * "Instant.now()". If this needs to be overridden, pass the value here. To effectively disable time based key
         * verification pass Instant.MAX (NOT recommended) </p><p> This is not possible in combination with
         * #withKeySelectionStrategy. </p>
         *
        ...
        /**
         * <p>The default strategy to search for keys is to *just* search for the email address (the part between &lt;
         * and &gt;). </p> <p>Set this flag to search for any part in the user id.</p>
         *
         * @return next build step
         */
        ...
        /**
         * Provide a custom strategy for key selection. Ideally a class derived from Rfc4880KeySelectionStrategy is
         * used.
         *
         * @param strategy the actual instance to use
         * @return next step in builder
         * @see Rfc4880KeySelectionStrategy
         */
    ...
    private class ValidationImpl implements Validation {
        ...
        public Build andRequireSignatureFromAllKeys(final Long... publicKeyIds) {
            ...
            BuildVerificationInputStreamAPI.this.signatureCheckingMode = SignatureValidationStrategies
        ...
        public final class Builder implements Build {
            ...
            /**
             * Build the final decrypted input stream. . This method will start reading the cipherstream until it finds
             * the encrypted plaintext. . If the source data is NOT signed, but a signature is REQUIRED, then this
             * function might even throw. . Signatures are verified AFTER decryption (reading the whole(!) plaintext
             * stream).
             *
             * @param signedData An encrypted input stream. Will not be closed.
             * @return Plaintext stream. Signatures are checked the moment EOF is reached.
             * @throws IOException             IO is dangerous. Also wraps several GPG exceptions.
             * @throws NoSuchProviderException BC provider is not registered
             */
            @Override
            @Nonnull
            public InputStream fromSignedInputStream(final @Nullable InputStream signedData)
                    throws IOException, NoSuchProviderException {

                requireNonNull(signedData, "encryptedData must not be null");

                final DecryptionStreamFactory pgpInputStreamFactory =
                        DecryptionStreamFactory.create(
                                BuildVerificationInputStreamAPI.this.keyringConfig,
                                BuildVerificationInputStreamAPI.this.signatureCheckingMode);

                return pgpInputStreamFactory.wrapWithDecryptAndVerify(signedData);
            }
        }
    }
}
